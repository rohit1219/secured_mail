<?php
   ...
   if (!empty($_COOKIE['password']) && $_COOKIE['password'] == $json_data['pass'])
   {
      ...
      if(isset($_FILES['file']))
      {
         ...
         $message   =  "<html><body><p>Hello Sir/Ma'am</p> <p> Username : ".$user_mail." </p> <p> Password : ".$password." </p> Please <a href= ".$base_url .'click.php'.">click here</a> To Download The Attachment </body></html>";
